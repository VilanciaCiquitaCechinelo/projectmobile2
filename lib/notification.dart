...
class FirebaseMessagingHandler {
  ...
  Future<void> initPushNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      print('Message received while app is in foreground: ${notification.title}');
    });

    // Handler when opening the message
...
// Definisi variabel channel
const _channelId = 'your_channel_id';
const _channelName = 'Your Channel Name';
const _channelDesc = 'Description of your channel';
